          ...
          <div className='grid sm:grid-cols-2 '>
              ...
              <div className='h-screen grid  justify-center'>
                  <div className='mt-32'>
                      ...
                      <form className="flex  flex-col gap-4 md:w-96" onSubmit={handleSignup}>
                          <div>
                          ...
                          <div className='text-center mt-5'>
                              <h2>Have an account? <a href='/login' className='text-indigo-700 font-medium underline decoration-solid'>Sign in</a></h2>
                          </div>
                      </form>
                  </div>
              </div>
              <div className='relative  overflow-hidden'>
                  ...
                  <img src={dashMockup.src} alt='' className='h-96 rounded-3xl absolute top-0 right-0 translate-y-52 translate-x-40' />
              </div>
          </div>
      </>
  )
